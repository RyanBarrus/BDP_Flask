...
CROSS JOIN 
	...
	FROM (VALUES 
	('021-WRAPPEDJUMBOCSTRAW'),
	('021-WRAPPEDJIBSTRAWS')) AS X(ITEMNMBR)
) x


INSERT INTO dbo.SOP30200 VALUES
('021-SO-00000','021-MARTINMASON',2,0,GETDATE()),
('021-SO-00001','021-MARTINMASON',2,0,GETDATE()),
('021-SO-00002','021-M&M ST JOHN',2,0,GETDATE()),
('021-SO-00003','021-KEYSTONE',2,0,GETDATE()),
('021-SO-00004','021-MB HARRIMAN',2,0,GETDATE()),
('021-SO-00005','021-KEYSTONE',2,0,GETDATE()),
('021-SO-00006','021-MB HARRIMAN',2,0,GETDATE())
